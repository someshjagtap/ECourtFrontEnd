...
export class ListComponent implements OnInit {
  ...
  listColumnsIntl() {
    ...
    this.columns = [
      ...
      {
        header: this.translate.instant('hospital_list.six_eightAM'),
        field: 'sixToEightAM',
        sortable: false,
        minWidth: 100,
        showExpand: this.expandable,
      ...
      {
        header: this.translate.instant('hospital_list.O2_in_L/min(FiO2)'),
        field: 'oxySixToEightAM',
        sortable: false,
        minWidth: 100,
        showExpand: this.expandable,
        //  pinned: 'left',
      ...
      {
        header: this.translate.instant('hospital_list.eight_To_Ten'),
        field: 'eightToTenAM',
        sortable: false,
        minWidth: 100,
        showExpand: this.expandable,
      ...
      {
        header: this.translate.instant('hospital_list.ten_To_Twelve'),
        field: 'tenToTwelveAM',
        sortable: false,
        minWidth: 100,
        showExpand: this.expandable,
      ...
      {
        header: this.translate.instant('hospital_list.oxy_TenTotwelveAM'),
        field: 'oxyTenToTwelveAM',
        sortable: false,
        minWidth: 100,
        showExpand: this.expandable,
        //  pinned: 'left',
      ...
      {
        header: this.translate.instant('hospital_list.twelve_To_Two'),
        field: 'twelveToTowPM',
        sortable: false,
        minWidth: 100,
        showExpand: this.expandable,
      ...
      {
        header: this.translate.instant('hospital_list.two_To_four'),
        field: 'twoToFourPM',
        sortable: false,
        minWidth: 100,
        showExpand: this.expandable,
      ...
      {
        header: this.translate.instant('hospital_list.four_To_six'),
        field: 'fourToSixPM',
        sortable: false,
        minWidth: 100,
        showExpand: this.expandable,
  ...
  queryData() {
   ...
   // this.search["auditId.equals"] == this.auditId;
    ...
    // this.lookupService.queryAuditPatientMonitoringForms(this.search).subscribe((res: HttpResponse<patientMonitorFormAMDTO[]>) => {
    //   const headers = res.headers;
    //   this.pageContext.totalItems = +headers.get('x-total-count');
    //   this.list = res.body;
    //   this.isLoading = false;

    //   //console.log("Audit Status "+this.auditDTO.auditStatus);
