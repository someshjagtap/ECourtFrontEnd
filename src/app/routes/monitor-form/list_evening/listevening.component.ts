...
@Component({
  selector: 'app-listevening',
  templateUrl: './listevening.component.html',
  styleUrls: ['./listevening.component.scss']
})
export class ListeveningComponent implements OnInit {
  ...
  listColumnsIntl() {
    ...
    this.columns = [
      ...
      {
        header: this.translate.instant('hospital_list.ward_no'),
        field: 'wardNo',
        sortable: false,
        minWidth: 0,
      ...
      {
        header: this.translate.instant('hospital_list.Patient_name'),
        field: 'patientName',
        sortable: false,
        minWidth: 100,
        showExpand: this.expandable,
      ...
      {
        header: this.translate.instant('hospital_list.bed_No'),
        // DTO Value
        field: 'bedNo',
        sortable: false,
        minWidth: 100,
      ...
      {
        header: this.translate.instant('hospital_list.date_Of_Admission'),
      ...
      {
        header: this.translate.instant('hospital_list.oxygen_Type'),
        field: 'oxygenType',
        sortable: false,
        minWidth: 100,
        showExpand: this.expandable,
      ...
      {
        header: this.translate.instant('hospital_list.six_eightPM'),
        field: 'sixToEightPM',
        sortable: false,
        minWidth: 100,
        showExpand: this.expandable,
      ...
      {
        header: this.translate.instant('hospital_list.oxy_six_toEightPM'),
        field: 'oxySixToEightPM',
        sortable: false,
        minWidth: 100,
        showExpand: this.expandable,
        // pinned: 'left',
      ...
      {
        header: this.translate.instant('hospital_list.eight_to_TenPM'),
        field: 'eightToTenPM',
        sortable: false,
        minWidth: 100,
        showExpand: this.expandable,
      ...
      {
        header: this.translate.instant('hospital_list.oxy_eight_to_TenPM'),
        field: 'oxyEightToTenPM',
        sortable: false,
        minWidth: 100,
        showExpand: this.expandable,
        // pinned: 'left',
      ...
      {
        header: this.translate.instant('hospital_list.ten_TO_TwelvePM'),
        field: 'tenToTwelvePM',
        sortable: false,
        minWidth: 100,
        showExpand: this.expandable,
      ...
      {
        header: this.translate.instant('hospital_list.oxy_ten_to_TwelvePM'),
        field: 'oxyTenToTwelvePM',
        sortable: false,
        minWidth: 100,
        showExpand: this.expandable,
        // pinned: 'left',
      ...
      {
        header: this.translate.instant('hospital_list.twelve_to_TwoAM'),
        field: 'twelveToTwoAM',
        sortable: false,
        minWidth: 100,
        showExpand: this.expandable,
      ...
      {
        header: this.translate.instant('hospital_list.oxy_twelve_to_TwoAM'),
        field: 'oxyTwelveToTwoAM',
        sortable: false,
        minWidth: 100,
        showExpand: this.expandable,
        // pinned: 'left',
      ...
      {
        header: this.translate.instant('hospital_list.two_to_fourAM'),
        field: 'twoToFourAM',
        sortable: false,
        minWidth: 100,
        showExpand: this.expandable,
      ...
      {
        header: this.translate.instant('hospital_list.oxy_two_to_FourAM'),
        field: 'oxyTwoToFourAM',
        sortable: false,
        minWidth: 100,
        showExpand: this.expandable,
        // pinned: 'left',
      ...
      {
        header: this.translate.instant('hospital_list.four_to_SixAM'),
        field: 'fourToSixAM',
        sortable: false,
        minWidth: 100,
        showExpand: this.expandable,
      ...
      {
        header: this.translate.instant('hospital_list.oxy_four_to_SixAM'),
        field: 'oxyFourToSixAM',
        sortable: false,
        minWidth: 100,
        showExpand: this.expandable,
        // pinned: 'left',
      ...
      {
        header: this.translate.instant('hospital_list.dr_name'),
        field: 'drName',
        sortable: false,
        minWidth: 100,
        showExpand: this.expandable,
      ...
      {
        header: this.translate.instant('hospital_list.nurse_name'),
        field: 'nurseName',
        sortable: false,
        minWidth: 100,
        showExpand: this.expandable,
  ...
  queryData() {
    this.isLoading = true;
    this.search['formName.contains'] = 'MonitorForm';
    ...
    // this.lookupService.queryAuditPatientMonitoringFormsPM(this.search).subscribe((res: HttpResponse<patientMonitorFormPMDTO[]>) => {
    ...
    //   || this.auditDTO.isOxygenMonitoringStatus == "INREVIEW"
    //   || this.auditDTO.isOxygenMonitoringStatus == "COMPLETED"))
    //   {
  ...
  add(data) {
    ...
    const dialogRef = this.dialog.originalOpen(CreateeveningComponent, {
      width: '100%',
      height:'650px',
      disableClose: true
